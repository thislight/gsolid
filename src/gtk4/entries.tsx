...
export const Entry: Component<EntryProps> = (props) => {
  // @ts-expect-error: idk why the @girs/gtk-4.0@4.12.5-3.3.0 depends on @girs/gsk-4.0@4.0.0-4.0.0-rc.15, pulling in incompatible @girs/pango-1.0@1.57.1-4.0.0-rc.15
  return createWidget(Gtk.Entry, props);
};
